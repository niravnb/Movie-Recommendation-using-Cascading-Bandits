%% Figure 1a: Comparison of n-step regret of baselines at L= 16 .
clc; clear all; 
close all;
...
title(['L = 16, K = 4'],'FontWeight','bold','FontSize',15);
